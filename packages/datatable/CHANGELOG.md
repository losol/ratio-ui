...
- 2cb07cf: TanStack Table is now a dependency, not a peer. `@tanstack/react-table` and
...
- 107ae67: `DataTable` renders through Ratio UI's `Table` instead of hardcoded Tailwind
...
- 67812fc: **Breaking:** upgrades to TanStack Table v9. The peer dependencies now require
