...
import { extractHeadings as extractHeadingsWith } from '@eventuras/markdown-react';

/**
 * `@eventuras/markdown-react`'s `extractHeadings` bound to ratio-ui's
 * `slugify`, so ids match the
